# GitPilot by RuslanMV controlled prompt example
...
```text
https://api.ruslanmv.com/v1/matrix-bundles/bundle_github_repo_intelligence_standard?open_file=coder-prompts/gitpilot.md
```
