...
class Settings:
    ...
    public_app_url: str = "https://build.matrixhub.io"
    ...
    def allowed_app_origins(self) -> list[str]:
        raw = self.app_origins or "https://build.matrixhub.io,https://ruslanmv-matrix-builder.hf.space,http://localhost:3000,http://localhost:7860,http://localhost:8000"
