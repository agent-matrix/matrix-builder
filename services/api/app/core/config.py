...
def get_settings() -> Settings:
    return Settings(
        ...
        enable_security_headers=_bool('ENABLE_SECURITY_HEADERS','true'), enable_hsts=_bool('ENABLE_HSTS','false'), hsts_max_age_seconds=int(os.getenv('HSTS_MAX_AGE_SECONDS','31536000')), content_security_policy=os.getenv('CONTENT_SECURITY_POLICY',"default-src 'self'; frame-ancestors 'none'; base-uri 'self'"),
